      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 min-h-[75vh] flex items-center justify-center">
        <div className="w-full grid md:grid-cols-2 gap-12 md:gap-16 place-items-center text-center">
          ...
          <div className="group flex flex-col items-center text-center px-8 py-10 rounded-2xl bg-transparent backdrop-blur-md border border-white/10">
            <div className="flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-indigo-600 to-blue-500 text-white shadow-2xl shadow-indigo-600/30">
            ...
            <h2 className="mt-6 text-4xl md:text-5xl font-bold tracking-tight">
              <span className="bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent">One-to-one</span>
            </h2>
            <p className="mt-4 text-gray-600 max-w-xl">
              Find individuals to hang out, study, or date. Personalized matches for easy one‑on‑one connections.
            </p>
            <Button className="mt-8 px-7 py-3.5 rounded-full" onClick={() => go('user')} aria-label="Choose one-to-one">
              Start 1:1
            </Button>
          </div>
          ...
          {/* Group */}
          <div className="group flex flex-col items-center text-center px-8 py-10 rounded-2xl bg-transparent backdrop-blur-md border border-white/10">
            <div className="flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-emerald-600 to-green-500 text-white shadow-2xl shadow-emerald-600/30">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h2 className="mt-6 text-4xl md:text-5xl font-bold tracking-tight">
              <span className="bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent">Group Hangout</span>
            </h2>
            <p className="mt-4 text-gray-600 max-w-xl">
              Discover groups for events, games, and meetups. Great for hosting or joining group activities on campus.
            </p>
            <Button variant="secondary" className="mt-8 px-7 py-3.5 rounded-full" onClick={() => go('group')} aria-label="Choose group hangout">
              See Groups
            </Button>
          </div>
        </div>
